...
def generar_recibo():
    ...
    try:
        ...
        fuente_titulo = ImageFont.truetype("aptos.ttf", 28)
        fuente_subtitulo = ImageFont.truetype("aptos.ttf", 26)
        fuente_normal = ImageFont.truetype("aptos.ttf", 24)
        fuente_pequena = ImageFont.truetype("aptos.ttf", 22)
    except:
